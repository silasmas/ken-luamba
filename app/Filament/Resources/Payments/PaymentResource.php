...
class PaymentResource extends Resource
{
  ...
  /**
   * Les paiements sont créés automatiquement avec les commandes.
   *
  ...
  /**
   * Précharge commande, client et articles pour l'affichage enrichi.
   *
   * @return Builder<Payment> Requête optimisée
   */
