...
/**
 * Affiche les variables dynamiques des alertes sortie comme boutons copiables.
 */
class BookReleasePlaceholderHelper
{
  /**
  ...
  public static function toHtml(): HtmlString
  {
    ...
    foreach (BookReleaseMessageService::placeholderDefinitions() as $token => $description) {
